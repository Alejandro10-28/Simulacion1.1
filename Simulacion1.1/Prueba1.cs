    ...
    public partial class Prueba1 : Form
    {
        ...
        private void btnVarianza_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (destadistico < Distribucion)
                {
                    lblR2.Text = "Los números son independientes\n y por lo tanto están listos\n para usarse.";
                }
                else
                {
                    lblR2.Text = "Los números no son independientes\n y por lo tanto debes\n utilizar otros números .";
        ...
        private void txtDestadisticos_TextChanged(object sender, EventArgs e)
        {
